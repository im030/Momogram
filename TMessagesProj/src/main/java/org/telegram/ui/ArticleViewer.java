    ...
    private void showCopyPopup(String urlFinal) {
        ...
        builder.addItems(
                ...
                new int[]{R.drawable.baseline_open_in_browser_24, R.drawable.baseline_content_copy_24, R.drawable.wallet_qr}, (which, text, cell) -> {
                    if (parentActivity == null || pages[0].adapter.currentPage == null) return Unit.INSTANCE;
                    if (which == 0 || which == 2) {
                        int index;
...
//                    ObjectAnimator.ofFloat(pages[1], View.ALPHA, 1.0f, 0.0f)
    ...
    public CharSequence getText(TLRPC.WebPage page, View parentView, TL_iv.RichText parentRichText, TL_iv.RichText richText, TL_iv.PageBlock parentBlock, int maxWidth, boolean noTranslate) {
        return getText(this, page, parentView, parentRichText, richText, parentBlock, maxWidth, noTranslate);
    }
...
//                }
        ...
        searchUpButton.setColorFilter(new PorterDuffColorFilter(getThemedColor(Theme.key_windowBackgroundWhiteBlackText), PorterDuff.Mode.SRC_IN));
        ...
        searchDownButton.setColorFilter(new PorterDuffColorFilter(getThemedColor(Theme.key_windowBackgroundWhiteBlackText), PorterDuff.Mode.SRC_IN));
    ...
    private boolean open(final MessageObject messageObject, TLRPC.WebPage webpage, String url, String webUrl, Browser.Progress progress) {
        ...
        if (webpage != null) {
            ...
            if (!localWebpage) {
                ...
                final TLRPC.TL_messages_getWebPage req = new TLRPC.TL_messages_getWebPage();
                req.url = webpage.url;
                if (webpage.cached_page != null && (webpage.cached_page instanceof TL_iv.TL_pagePart_layer82 || webpage.cached_page.part)) {
                    req.hash = 0;
                } else {
    ...
    public static class BlockChannelCell extends FrameLayout implements TextSelectionHelper.ArticleSelectableView {
        ...
        public void setBlock(TL_iv.pageBlockChannel block) {
            ...
            if (currentType == 0) {
                ...
                imageView.setColorFilter(new PorterDuffColorFilter(parent.getGrayTextColor(), PorterDuff.Mode.SRC_IN));
            } else {
