 ...
 * (values/strings_neko.xml, strings_nekox.xml, ...).
 *
...
abstract class TelegramNamespaceStringsTask : DefaultTask() {
    ...
    fun generate() {
        ...
        // Remove stale namespace assets from previous runs.
        assetsDir
            .listFiles { file ->
                file.isFile &&
        ...
        // Lists keep insertion order: a later file wins (overlay semantics).
        ...
        for ((namespace, filesByTag) in filesByNamespace) {
            // Union of all keys inside this namespace.
            ...
            // Hash collisions are detected per namespace: different
            // namespaces may reuse the same key.
    ...
    private companion object {
        // localization_<tag>_<namespace>.bin, e.g. localization_pt_br_neko.bin.
